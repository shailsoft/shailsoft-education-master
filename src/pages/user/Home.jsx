        ...
        <div className="container com-sp pad-bot-70">
          <div className="row">
            <div className="con-title">
              ...
              <p>
                Explore our programs, campus life, research initiatives and the
        ...
        <div className="container com-sp pad-bot-70">
          <div className="row">
            <div className="con-title">
              ...
              <p>
                Our most-booked programs this semester, from engineering to
                design.
              </p>
            </div>
          </div>
        ...
        <div className="container com-sp pad-bot-70">
          <div className="row">
            <div className="con-title">
              ...
              <p>
                Stay up to date with seminars, admission tours, and on-campus
                conferences.
              </p>
            </div>
          </div>
