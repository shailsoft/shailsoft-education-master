          ...
          <div className="col-md-12">
            ...
            <div className="main-menu">
              <ul>
                      ...
                      <div className="m-menu-inn">
                        ...
                        <div className="mm1-com mm1-s2">
                          <p>
                            ...
                            just that. Join our community and help shift the
                            global conversation every single day.
                          </p>
                        ...
                        <div className="mm1-com mm1-s4">
                          <ul>
                            ...
                            <li>
                              <Link to="/db-courses">Dashboard courses</Link>
                            </li>
                            <li>
                              <Link to="/db-exams">Dashboard exams</Link>
                            </li>
                            <li>
                              <Link to="/db-profile">Dashboard profile</Link>
                            </li>
                            <li>
                              <Link to="/db-time-line">Dashboard timeline</Link>
                            </li>
                          </ul>
                        </div>
                      </div>
                ...
                <li
                  className="admi-menu"
                  onMouseEnter={show("admi")}
                  onMouseLeave={hide}
                >
                  <Link to="/admission" className="mm-arr">
                    Admission
                  </Link>
                  <div className="mm-pos">
                    <div className="admi-mm m-menu" style={mmStyle("admi")}>
                      <div className="m-menu-inn">
                        {[
                          ...
                          <div
                            key={item.label}
                            className="mm2-com mm1-com mm1-s1"
                          >
                            <div className="ed-course-in">
                            ...
                            <p>
                              Discover our programs and opportunities across
                              academics, admissions, and campus life.
                            </p>
                            <Link to={item.to} className="mm-r-m-btn">
                              Read more
                            </Link>
                          </div>
                        ))}
                      ...
                      <div className="m-menu-inn">
                        ...
                        <div className="mm1-com mm1-cour-com mm1-s3">
                          ...
                          <ul>
                            ...
                            <li>
                              <Link to="/admin/all-courses">All courses</Link>
                            </li>
                            <li>
                        ...
                        <div className="mm1-com mm1-cour-com mm1-s3">
                          ...
                          <ul>
                            ...
                            <li>
                              <Link to="/admin/event-edit">Event edit</Link>
                            </li>
                            <li>
                            ...
                            <li>
                              <Link to="/admin/job-add">Add new job</Link>
                            </li>
                            <li>
                              <Link to="/admin/page-add">Add new page</Link>
                            </li>
                          </ul>
                        </div>
                        <div className="mm1-com mm1-cour-com mm1-s4">
                          ...
                          <ul>
                            <li>
                              <Link to="/admin/quick-link">Quick link</Link>
                            </li>
                            <li>
                              <Link to="/admin/seminar-add">Add seminar</Link>
                            </li>
                            <li>
                              <Link to="/admin/seminar-all">All seminars</Link>
                            </li>
                            <li>
                              <Link to="/admin/all-enquiry">All enquiry</Link>
                            </li>
                            <li>
                              <Link to="/admin/view-enquiry">Enquiry view</Link>
                            </li>
                            <li>
                            ...
                            <li>
                              <Link to="/admin/main-menu">Menu - Main</Link>
                            </li>
                            <li>
                              <Link to="/admin/about-menu">Menu - About</Link>
                            </li>
                            <li>
